      ...
      <article className="bg-white p-8 space-y-6 text-[#495464] leading-relaxed rounded-xs shadow-sm">
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            otherwise. Shipping costs are shown at checkout. Product information,
            pricing, and availability may change at any time. We reserve the
            right to correct errors and cancel orders affected by incorrect
